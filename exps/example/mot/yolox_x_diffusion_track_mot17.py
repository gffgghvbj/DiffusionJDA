...
class Exp(MyExp):
    def __init__(self):
        ...
        self.interval = 5
        self.config = '/media/cvlab1045/D1/sp/code/DiffusionTrack-main/config/3_layer.yaml'
    ...
    def get_model(self):
        ...
        from diffusion.models.diffusionnet import DiffusionNet, DiffusionHead, AssociatedHead
        ...
        if getattr(self, "model", None) is None:
            ...
            asso_head = AssociatedHead(config)
            # for i in range(6):
            #     for param in head.head.head_series[i].asso_net.parameters():
            #         param.requires_grad = True
            self.model = DiffusionNet(backbone, head, asso_head)
            for param in self.model.parameters():
                param.requires_grad = False
            for param in self.model.assohead.parameters():
                param.requires_grad = True
