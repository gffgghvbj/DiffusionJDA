...
class DiffusionTracker(object):
    ...
    def update(self, cur_image):
        ...
        if self.frame_id == 1:
            ...
            matches, u_track, u_detection = min_cost_matching(adap_flag=True, max_distance=0.45, tracks=ref_bboxes,
                                                              detections=ref_dets, cost_matrix=dists)
            # print(matches)
            ...
            if len(matches) > 0:
                ...
                # matches_fix, u_track_fix, u_detection_fix = min_cost_matching(adap_flag=True, max_distance=0.45,
                #                                                               tracks=track_dets,
                #                                                               detections=detections,
                #                                                               cost_matrix=dists_fix)
